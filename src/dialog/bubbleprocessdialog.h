...
private slots:
    void on_But_bubbleFilesSetRootDir_3_clicked();

    void on_But_fetchBubbleFiles_3_clicked();

    void on_But_chooseFile_3_clicked();

    void on_ComboBox_fetchedBubbles_3_currentIndexChanged(int index);

    void on_But_readPoseData_3_clicked();

    void on_But_transformBubbles_3_clicked();
